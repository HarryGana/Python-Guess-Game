import random
print("Welcome to Start.NG number guess game,there are three levels in the game: easy, medium and hard ")
user_name = input('Please enter your user name to begin: ').upper()
user_level = input('Please pick your preferred level: ').lower()
Turns =0
limit = 6
left = 6
